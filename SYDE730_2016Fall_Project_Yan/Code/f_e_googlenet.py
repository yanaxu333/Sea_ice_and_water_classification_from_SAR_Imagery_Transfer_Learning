...
print getAllImages("/home/lein/Yan_Project/24/more_patches")

imageList=getAllImages("/home/lein/Yan_Project/24/more_patches")
pid=0
...
for i in range(0,roundnum):
    ...
    while j<10:
        ...
        image_root='/home/lein/Yan_Project/24/more_patches/'+imageList[pid]
...
sio.savemat('/home/lein/Yan_Project/24/f6g_4_1',{'data':returnmat[0:75484,:]})

sio.savemat('/home/lein/Yan_Project/24/f6g_4_2',{'data':returnmat[75484:150968,:]})
