...
print getAllImages("/home/lein/Yan_Project/22/patches_1")

imageList=getAllImages("/home/lein/Yan_Project/22/patches_1")
pid=0
...
for i in range(0,roundnum):
    ...
    while j<10:
        ...
        image_root='/home/lein/Yan_Project/22/patches_1/'+imageList[pid]
...
sio.savemat('/home/lein/Yan_Project/22/f6_2',{'data':returnmat[:,:]})
