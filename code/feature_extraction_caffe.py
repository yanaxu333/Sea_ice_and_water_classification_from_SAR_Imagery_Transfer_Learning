...
print getAllImages("/home/lein/Yan_Project/22/patches")

imageList=getAllImages("/home/lein/Yan_Project/22/patches")
pid=0
...
for i in range(0,roundnum):
    ...
    while j<10:
        ...
        image_root='/home/lein/Yan_Project/22/patches/'+imageList[pid]
